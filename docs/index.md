...
| 2 | [Tkinter GUI 기초](chapter2.md) | 첫 윈도우 프로그램 만들기 | 3-4시간 | ⭐⭐⭐⭐ | "내가 프로그램을 만들었다!" |
| **🚀 핵심 기능 구현** |
| 3 | [기본 GUI 구조](chapter3.md) | 실제로 사용할 수 있는 화면 설계 | 2-3시간 | ⭐⭐⭐⭐ | 진짜 프로그램의 모습이 보인다 |
| 4 | [드래그 앤 드롭](chapter4.md) | 마우스로 파일을 끌어서 놓기 | 3-4시간 | ⭐⭐⭐⭐⭐ | "와! 정말 프로그램 같다!" |
| 5 | [파일명 변경 로직](chapter5.md) | 실제로 파일명을 바꾸는 핵심 기능 | 4-5시간 | ⭐⭐⭐⭐⭐ | 진짜 문제를 해결하는 순간! |
| 6 | [고급 기능](chapter6.md) | 필터링, 설정 저장, 되돌리기 | 3-4시간 | ⭐⭐⭐⭐⭐ | 완성도 높은 프로그램 완성 |
| **💎 전문가 수준** |
| 7 | [모듈화](chapter7.md) | 코드를 체계적으로 정리하기 | 2-3시간 | ⭐⭐⭐⭐ | 프로처럼 코딩하는 법 |
| 8 | [단위 테스트](chapter8.md) | 버그 없는 안전한 코드 작성 | 3-4시간 | ⭐⭐⭐⭐ | 현업에서 쓰는 개발 방법 |
| 9 | [문서화](chapter9.md) | 전문적인 프로젝트 문서 만들기 | 2-3시간 | ⭐⭐⭐ | 포트폴리오 완성도 UP |
| **🌟 배포** |
| 10 | [CI/CD](chapter10.md) | 자동화된 개발 파이프라인 | 2-3시간 | ⭐⭐⭐⭐ | 진짜 개발자의 워크플로우 |
| 11 | [PyPI 배포](chapter11.md) | 전세계에 내 패키지 배포하기 | 1-2시간 | ⭐⭐⭐⭐⭐ | "내가 오픈소스 개발자!" |
| 12 | [실행파일 생성](chapter12.md) | 설치 없이 실행되는 .exe 만들기 | 2-3시간 | ⭐⭐⭐⭐⭐ | 누구나 쓸 수 있는 완전한 프로그램 |

**총 예상 학습 시간: 30-42시간** (주말에 조금씩 하면 1-2개월 완주!)
